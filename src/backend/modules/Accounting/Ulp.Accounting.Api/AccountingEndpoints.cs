...
public static class AccountingEndpoints
{
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/accounts").WithTags("M17 · Chart of Accounts").RequireAuthorization();
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/periods").WithTags("M17 · Periods").RequireAuthorization();
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/invoices").WithTags("M17 · AR Invoices").RequireAuthorization();
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/bills").WithTags("M17 · AP Bills").RequireAuthorization();
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/receipts").WithTags("M17 · Receipts").RequireAuthorization();
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/payments").WithTags("M17 · Payments").RequireAuthorization();
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/journals").WithTags("M17 · Journals").RequireAuthorization();
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/reports").WithTags("M17 · Reports").RequireAuthorization();
