...
public static class AccountingExtEndpoints
{
    ...
    {
        var sl = app.MapGroup("/api/v1/accounting/settlement-links").WithTags("M17 · Settlement").RequireAuthorization();
        ...
        var bank = app.MapGroup("/api/v1/accounting/bank-accounts").WithTags("M17 · Bank").RequireAuthorization();
        bank.MapGet("/", async ([FromServices] IFinanceExtService svc, CancellationToken ct) =>
            Results.Ok(await svc.ListBankAccountsAsync(ct)));

        var dep = app.MapGroup("/api/v1/accounting/deposits").WithTags("M17 · Deposits").RequireAuthorization();
        ...
        var stmt = app.MapGroup("/api/v1/accounting/bank-statements").WithTags("M17 · Bank Statements").RequireAuthorization();
        ...
        var recon = app.MapGroup("/api/v1/accounting/bank-recons").WithTags("M17 · Bank Reconciliation").RequireAuthorization();
        ...
        var ft = app.MapGroup("/api/v1/accounting/fund-transfers").WithTags("M17 · Fund Transfers").RequireAuthorization();
        ...
        var voids = app.MapGroup("/api/v1/accounting/voided-checks").WithTags("M17 · Voided Checks").RequireAuthorization();
        ...
        var checkPrint = app.MapGroup("/api/v1/accounting/check-print-batches").WithTags("M17 · Print").RequireAuthorization();
        ...
        var invPrint = app.MapGroup("/api/v1/accounting/invoice-print-batches").WithTags("M17 · Print").RequireAuthorization();
        ...
        var pdn = app.MapGroup("/api/v1/accounting/past-due-notices").WithTags("M17 · Past Due").RequireAuthorization();
        ...
        var et = app.MapGroup("/api/v1/accounting/email-templates").WithTags("M17 · Email Templates").RequireAuthorization();
        ...
        var cc = app.MapGroup("/api/v1/accounting/credit-card-payments").WithTags("M17 · Credit Card").RequireAuthorization();
        ...
        var ge = app.MapGroup("/api/v1/accounting/general-expenses").WithTags("M17 · General Expense").RequireAuthorization();
        ...
        var rep = app.MapGroup("/api/v1/accounting/reports-ext").WithTags("M17 · Reports Ext").RequireAuthorization();
