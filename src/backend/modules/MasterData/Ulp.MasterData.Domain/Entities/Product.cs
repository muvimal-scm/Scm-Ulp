...
/// <summary>
/// Product master. Per ULP_LLD_M1_v2.0_MasterData.docx §5.
/// Classification fields (HS / HSN / HTSUS / Schedule B) coexist —
...
public sealed class Product : IEntity, ITenantScoped
{
    ...
    public string UomCode { get; set; } = "";         // FK → m1_uom.code
    public decimal? WeightKg { get; set; }
    public decimal? VolumeCbm { get; set; }

    // Classification — multi-system per LLD §5.1
...
/// <summary>Per LLD §5 — enumeration of product types.</summary>
