...
namespace Ulp.FreightForwarding.Domain.Entities;
...
public sealed class Booking
{
    ...
    public LocalDate? EstimatedCrd { get; set; }            // Cargo Ready Date â€” required once OrderConfirmed
...
// LLD enum extended 2026-05-03 per SCM Milestone 2 spec â€” adds explicit
...
public sealed class Shipment
{
    ...
    public long?     BookingId { get; set; }
    public TransportMode Mode { get; set; }
    // v2 client doc CP13 delta: trade direction surfaced on shipment for the
    // Ocean/Air × Imp/Exp tab filter. Backfilled from booking on existing rows.
    public TradeDirection? TradeDirection { get; set; }
...
// LLD enum extended 2026-05-03 per SCM Milestone 2 spec â€” adds AtPOD,
...
/* ===================== Memo (SCM Milestone 1 â€” internal notes per shipment) ===================== */
...
/* ===================== Watchlist (SCM Milestone 1+2 â€” starred shipments per user) ===================== */
...
/* ===================== Hold (SCM Milestone 1+2 â€” operational holds on a shipment) ===================== */
...
// v2 client doc M2 typology: BL / Freight / Customs / TerminalFees are the
// "Track Shipment Holds" categories. Existing Pga/MissingDoc/etc. retained
// for backward compatibility with already-seeded rows.
public enum HoldType { Customs, Pga, MissingDoc, CustomerDispute, Payment, Operations, Other, Bl, Freight, TerminalFees }

/* ===================== Reminder (SCM Milestone 1+2 â€” date-driven, fired by RunRemindersNow) ===================== */
