...
public static class CustomsEndpoints
{
    ...
    {
        var entries = app.MapGroup("/api/v1/customs/entries").WithTags("M4 · Entries").RequireAuthorization();
        ...
        var ros = app.MapGroup("/api/v1/customs/release-orders").WithTags("M4 · Release Orders").RequireAuthorization();
        ...
        var abi = app.MapGroup("/api/v1/customs/abi-messages").WithTags("M4 · ABI Messages").RequireAuthorization();
