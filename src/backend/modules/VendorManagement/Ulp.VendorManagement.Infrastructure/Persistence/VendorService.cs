...
public sealed class VendorService(VendorManagementDbContext db, ITenantContext tenant, IClock clock) : IVendorService
{
    /* =====================================================================
     *  Vendor lifecycle
     * ===================================================================== */
    ...
    /* =====================================================================
     *  Onboarding workflow (LLD Â§4) â€” synchronous Phase 1; Hangfire pipeline Phase 2
     * ===================================================================== */
