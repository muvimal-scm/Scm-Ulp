...
export class AppShellComponent implements OnInit {
  ...
  protected readonly navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        {
          label: 'TMSCube · Trucking ERP', icon: 'directions_bus', status: 'live',
          children: [
            { label: 'Dispatch Board',    icon: '', route: '/app/trucking/jobs',        status: 'live' },
            { label: 'Driver Roster',     icon: '', route: '/app/trucking/drivers',     status: 'live' },
            { label: 'Truck Fleet',       icon: '', route: '/app/trucking/trucks',      status: 'live' },
            { label: 'Chassis',           icon: '', route: '/app/trucking/chassis',     status: 'live' },
            { label: 'Maintenance Log',   icon: '', route: '/app/trucking/maintenance', status: 'live' },
          ],
        },
        {
          label: 'WMSCube · Warehouse', icon: 'warehouse', status: 'live', route: '/app/wms',
          children: [
            { label: 'Warehouses',             icon: '', route: '/app/wms',            status: 'live' },
            { label: 'Inbound & GRN',          icon: '', route: '/app/wms/grns',       status: 'live' },
            { label: 'Stock summary',          icon: '', route: '/app/wms/stock',      status: 'live' },
            { label: 'Pick lists',             icon: '', route: '/app/wms/pick-lists', status: 'live' },
    ...
    },
    {
      ...
      items: [
        {
          label: 'Reports & Analytics', icon: 'analytics', status: 'live',
          children: [
            { label: 'A/R Ageing',                icon: '', route: '/app/reports/ar-ageing',          status: 'live' },
            { label: 'A/P Ageing',                icon: '', route: '/app/reports/ap-ageing',          status: 'live' },
            { label: 'Revenue by Mode',           icon: '', route: '/app/reports/revenue-by-mode',    status: 'live' },
            { label: 'Demurrage Exposure',        icon: '', route: '/app/reports/demurrage-exposure', status: 'live' },
            { label: 'Audit Trail',               icon: '', route: '/app/reports/audit-trail',       status: 'live' },
