...
import { DocumentManagementApiService } from './shared/document-management-api.service';
import { DocumentDto, StorageQuotaDto } from './shared/document-management-types';
...
@Component({
  selector: 'ulp-document-management-documents',
  standalone: true,
  imports: [
...
export class DocumentsListComponent implements OnInit {
  private readonly api = inject(DocumentManagementApiService);
