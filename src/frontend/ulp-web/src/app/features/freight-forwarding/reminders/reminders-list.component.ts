...
import { ReminderStatus, ShipmentReminderDto } from '../shared/freight-forwarding-types';
...
@Component({
  selector: 'ulp-freight-forwarding-reminders',
  standalone: true,
          ...
          <tbody>
            @for (r of rows(); track r.id) {
              <tr [class.row-overdue]="isOverdue(r)">
                <td><a [routerLink]="['/app/freight-forwarding/shipments', r.shipmentId]" class="link">#{{ r.shipmentId }}</a></td>
