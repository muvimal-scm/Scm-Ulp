...
import { OtrJobDto } from '../shared/last-mile-types';

@Component({
  selector: 'ulp-otr-list',
  standalone: true,
  ...
  template: `
    <header class="page-head">
      <div class="head-row">
        <div>
          <h1>Over-The-Road Jobs</h1>
          <p>Long-haul domestic trucking shipments.</p>
        </div>
        <a mat-flat-button color="primary" routerLink="new"><mat-icon>add</mat-icon>&nbsp;New OTR Job</a>
      </div>
    </header>
    <nav class="tabs">
