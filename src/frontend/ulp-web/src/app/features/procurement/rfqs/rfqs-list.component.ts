...
import { RfqDto } from '../shared/procurement-types';

@Component({
  selector: 'ulp-procurement-rfqs',
  standalone: true,
  ...
  template: `
    <header class="page-head">
      <div class="head-row">
        <div>
          <h1>Vendor RFQs</h1>
          <p>Procurement-side RFQs sent to vendors with their bids.</p>
        </div>
    ...
    @if (loading()) {
      ...
      <div class="table-wrap">
        <table>
          <thead>
            <tr>
              <th>RFQ #</th><th>Country</th><th>Scope PR</th>
              <th>Due</th><th>Status</th>
              <th class="num">Recipients</th><th class="num">Responses</th><th></th>
            </tr>
          </thead>
          <tbody>
