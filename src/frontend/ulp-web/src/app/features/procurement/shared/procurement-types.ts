/**
 * M7 Procurement â€” DTOs that mirror src/backend/.../Ulp.Procurement.Application/Contracts.cs.
 */
...
/* ===================== Request DTOs (mirror Ulp.Procurement.Application) ===================== */
...
export interface CreatePrRequest {
  ...
  neededBy?: string | null;        // ISO date YYYY-MM-DD
  notes?: string | null;
}
...
export interface CreatePrLineRequest {
  ...
  uomCode?: string | null;
  estimatedUnitPriceAmount?: number | null;
  estimatedUnitPriceCurrency?: string | null;
}
