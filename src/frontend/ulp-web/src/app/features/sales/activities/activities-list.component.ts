...
import { ActivityDto } from '../shared/sales-types';

@Component({
  selector: 'ulp-sales-activities',
  standalone: true,
  ...
  template: `
    <header class="page-head">
      <div class="head-row">
        ...
        <a mat-flat-button color="primary" routerLink="new"><mat-icon>add</mat-icon>&nbsp;Log activity</a>
      </div>
    </header>
