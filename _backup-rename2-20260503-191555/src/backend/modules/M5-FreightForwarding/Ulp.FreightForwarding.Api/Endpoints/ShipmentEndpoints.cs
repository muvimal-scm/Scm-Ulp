...
public static class ShipmentEndpoints
{
    ...
    {
        var g = app.MapGroup("/api/v1/freight-forwarding/shipments").WithTags("M5 Â· Shipments").RequireAuthorization();
        ...
        // SCM Milestone 1+2 â€” Reminders (per-shipment add + per-shipment list).
