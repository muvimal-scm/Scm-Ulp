...
/// <summary>
/// SCM Milestone 1+2 â€” global reminders endpoints.
...
public static class ReminderEndpoints
{
    ...
    {
        var g = app.MapGroup("/api/v1/freight-forwarding/reminders").WithTags("M5 Â· Reminders").RequireAuthorization();
        ...
        // Phase-1 on-demand "fire due reminders" â€” same handler that Hangfire
