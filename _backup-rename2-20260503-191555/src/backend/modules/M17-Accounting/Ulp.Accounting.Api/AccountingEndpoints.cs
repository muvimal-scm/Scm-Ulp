...
/// <summary>
/// Maps the 18 endpoints from sealed LLD Â§11 plus chart-of-accounts read endpoints.
/// </summary>
public static class AccountingEndpoints
{
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/accounts").WithTags("M17 Â· Chart of Accounts").RequireAuthorization();
        ...
        {
            try   { return Results.Created("/api/v1/accounting/accounts", await svc.CreateAccountAsync(req, ct)); }
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/periods").WithTags("M17 Â· Periods").RequireAuthorization();
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/invoices").WithTags("M17 Â· AR Invoices").RequireAuthorization();
        ...
        {
            try   { return Results.Created("/api/v1/accounting/invoices", await svc.CreateInvoiceAsync(req, ct)); }
            catch (InvalidOperationException ex) { return Results.Conflict(new { error = ex.Message }); }
        });
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/bills").WithTags("M17 Â· AP Bills").RequireAuthorization();
        ...
        {
            try   { return Results.Created("/api/v1/accounting/bills", await svc.CreateBillAsync(req, ct)); }
            catch (InvalidOperationException ex) { return Results.Conflict(new { error = ex.Message }); }
        });
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/receipts").WithTags("M17 Â· Receipts").RequireAuthorization();
        ...
        {
            try   { return Results.Created("/api/v1/accounting/receipts", await svc.CreateReceiptAsync(req, ct)); }
            catch (InvalidOperationException ex) { return Results.Conflict(new { error = ex.Message }); }
        });
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/payments").WithTags("M17 Â· Payments").RequireAuthorization();
        ...
        {
            try   { return Results.Created("/api/v1/accounting/payments", await svc.CreatePaymentAsync(req, ct)); }
            catch (InvalidOperationException ex) { return Results.Conflict(new { error = ex.Message }); }
        });
    }
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/journals").WithTags("M17 Â· Journals").RequireAuthorization();
        ...
        {
            try   { return Results.Created("/api/v1/accounting/journals", await svc.CreateJournalAsync(req, ct)); }
            catch (InvalidOperationException ex) { return Results.BadRequest(new { error = ex.Message }); }
        });
    }
    ...
    {
        var g = app.MapGroup("/api/v1/accounting/reports").WithTags("M17 Â· Reports").RequireAuthorization();
