...
// =====================================================================
// M17 Accounts â€” Core domain entities (per sealed LLD Â§3 + Â§5 + Â§6 + Â§7 + Â§8)
// Plugin extension entities (m17in_*) are in AccountingInEntities.cs.
// =====================================================================

// LLD Â§3.1 â€” Chart of Accounts
...
// LLD Â§4 â€” multi-currency FX rates (RBI for IN, FED for US)
...
// LLD Â§5 â€” AR Invoice (state machine: Draft â†’ PendingApproval â†’ Approved â†’ Posted â†’ ...)
...
// LLD Â§5.3 â€” Receipts and matching
...
// LLD Â§7.2 â€” Period close checklist (universal + plugin-injected items)
...
// LLD Â§8.2 â€” append-only audit log
