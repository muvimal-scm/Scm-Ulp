...
// =====================================================================
// M17-IN plugin extension entities â€” India compliance (per LLD Â§12)
...
// LLD Â§5.2 plugin storage â€” India-specific invoice extension
...
// LLD Â§12.3 â€” IRN issued by IRP for B2B invoices > threshold
...
// LLD Â§6.2 plugin extension â€” India-specific bill extension (TDS)
...
// LLD Â§12.5 â€” GSTR returns runs
