...
public static class PermissionEndpoints
{
    ...
    {
        var g = app.MapGroup("/api/v1/identity/permissions").WithTags("M26 Â· Permissions").RequireAuthorization();

        // Read-only catalog â€” written via the seed migration, not the API.
