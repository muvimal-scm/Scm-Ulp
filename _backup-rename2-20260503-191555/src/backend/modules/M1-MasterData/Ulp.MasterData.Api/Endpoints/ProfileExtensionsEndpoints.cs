...
/// <summary>
/// SCM Milestone 1 â€” Profiles &amp; Settings extensions.
...
public static class ProfileExtensionsEndpoints
{
    ...
    {
        var g = app.MapGroup("/api/v1/master-data/parties/{partyId:long}").WithTags("M1 Â· Profile Extensions").RequireAuthorization();
