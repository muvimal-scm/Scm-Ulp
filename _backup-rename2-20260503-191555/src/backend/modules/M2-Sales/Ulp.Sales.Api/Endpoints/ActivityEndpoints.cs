...
public static class ActivityEndpoints
{
    ...
    {
        var g = app.MapGroup("/api/v1/sales/activities").WithTags("M2 Â· Activities").RequireAuthorization();
        ...
        g.MapPost("/", async (
            ...
            Results.Created("/api/v1/sales/activities/", await svc.AddActivityAsync(req, ct)));
