...
public static class TemplateEndpoints
{
    ...
    {
        var g = app.MapGroup("/api/v1/notifications/templates").WithTags("M27 Â· Templates").RequireAuthorization();
...
public static class ProviderTestEndpoints
{
    ...
    {
        var g = app.MapGroup("/api/v1/notifications/providers").WithTags("M27 Â· Providers").RequireAuthorization();
