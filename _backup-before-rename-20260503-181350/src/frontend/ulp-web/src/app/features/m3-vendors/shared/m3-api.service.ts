...
import {
  AgreementDto, CreateVendorRequest, NcrDto, OnboardingStepDto,
  PerformanceScoreDto, VendorCategoryCode, VendorDto, VendorStatus,
} from './m3-types';

@Injectable({ providedIn: 'root' })
export class M3ApiService {
  private readonly http = inject(HttpClient);
  private readonly base = `${environment.apiBaseUrl}/api/v1/m3`;
