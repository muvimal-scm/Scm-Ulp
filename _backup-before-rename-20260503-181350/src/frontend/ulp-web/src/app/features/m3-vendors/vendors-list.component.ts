...
import { M3ApiService } from './shared/m3-api.service';
import { VendorDto, VendorStatus } from './shared/m3-types';

@Component({
  selector: 'ulp-m3-vendors',
  standalone: true,
  ...
  template: `
    ...
    <div class="toolbar">
      ...
      <button mat-flat-button color="primary" disabled matTooltip="Create UI lands Phase 1.1">
          ...
          <tbody>
            @for (v of rows(); track v.id) {
              <tr>
                ...
                <td>
                  @if (v.categories.length === 0) { <em>—</em> }
                ...
                <td class="comp">
                  ...
                  @if (v.w9OnFile) { <span class="comp-flag comp-flag--ok">W-9 ✓</span> }
                </td>
                <td class="actions">
...
export class VendorsListComponent implements OnInit {
  private readonly api = inject(M3ApiService);
