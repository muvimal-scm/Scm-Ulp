...
@Component({
  ...
  template: `
    <nav class="bc">
      ...
      <a routerLink="/app/m1">Master Data</a> <span class="bc-sep">›</span>
      <a routerLink="/app/m1/parties">Parties</a> <span class="bc-sep">›</span>
    ...
    <section class="hero">
      ...
      <div class="hero__actions">
        <button mat-stroked-button routerLink="/app/m1/parties">Cancel</button>
      ...
      @if (isNew()) {
        <section class="card">
          ...
          <p class="muted">
            ...
            once the country plugin ships in Phase 3 — for now stored as Pending.
          </p>
          @for (id of identifiers(); track id; let i = $index) {
            <div class="row id-row">
              <mat-form-field appearance="outline">
                <mat-label>Type</mat-label>
                <input matInput [(ngModel)]="id.identifierType" placeholder="PAN | GSTIN | EIN | DUNS …">
              </mat-form-field>
              <mat-form-field appearance="outline">
...
export class PartyFormComponent implements OnInit {
  ...
  // Mutable form state — bound directly via ngModel
  protected f: {
    countryCode: string;
    partyType: PartyType;
    legalName: string;
  ...
  async save() {
    ...
    try {
      ...
      if (this.isNew()) {
        ...
        await this.router.navigate(['/app/m1/parties', created.id]);
      } else {
        ...
        await this.router.navigate(['/app/m1/parties']);
      }
    } catch (e) {
