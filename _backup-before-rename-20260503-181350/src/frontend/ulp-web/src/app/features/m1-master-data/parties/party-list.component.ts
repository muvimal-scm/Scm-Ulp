...
import { Party, PartyType, PartyTypes } from '../shared/m1-types';

@Component({
  selector: 'ulp-m1-party-list',
  standalone: true,
  imports: [
          ...
          <tbody>
            @for (p of rows(); track p.id) {
              <tr>
                ...
                <td class="actions">
                  <a [routerLink]="[p.id]" class="link">View</a>
                  <a [routerLink]="[p.id, 'profile']" class="link" style="margin-left:8px;">Profile</a>
                </td>
              </tr>
            }
          </tbody>
