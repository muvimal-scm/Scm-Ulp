...
@Component({
  ...
  template: `
    <nav class="bc">
      ...
      <a routerLink="/app/m1/products">Products</a> <span class="bc-sep">›</span>
    ...
    <section class="hero">
      ...
      <div class="hero__actions">
        <button mat-stroked-button routerLink="/app/m1/products">Cancel</button>
    ...
    @if (loading()) {
      ...
      <section class="grid-2">
        ...
        <div class="card">
          ...
          <p class="muted">Multi-system per LLD §5.1 — a product can carry HS, HSN, HTSUS, and Schedule&nbsp;B codes simultaneously.</p>
          <div class="row">
            <mat-form-field appearance="outline">
  ...
  async save() {
    ...
    try {
      if (this.isNew()) {
        ...
        await this.router.navigate(['/app/m1/products', created.id]);
      } else {
        ...
        await this.router.navigate(['/app/m1/products']);
      }
    } catch (e) {
