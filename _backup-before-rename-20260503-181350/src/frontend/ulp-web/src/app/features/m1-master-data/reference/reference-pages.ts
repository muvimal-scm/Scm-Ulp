...
import { M1ApiService } from '../shared/m1-api.service';
import { Country, Currency, Holiday, Port, StateOrProvince, Uom } from '../shared/m1-types';
...
@Component({
  ...
  template: `
    <nav class="bc">Home <span class="bc-sep">›</span> <a routerLink="/app/m1">Master Data</a> <span class="bc-sep">›</span> <span>Countries</span></nav>
...
export class CountriesComponent implements OnInit {
  private readonly api = inject(M1ApiService);
...
/* ================================================================== */
@Component({
  selector: 'ulp-m1-states',
  standalone: true,
  imports: [RouterLink, FormsModule, MatIconModule, MatFormFieldModule, MatInputModule, MatSelectModule, MatProgressSpinnerModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <nav class="bc">Home <span class="bc-sep">›</span> <a routerLink="/app/m1">Master Data</a> <span class="bc-sep">›</span> <span>States / Provinces</span></nav>
...
/* ================================================================== */
@Component({
  selector: 'ulp-m1-currencies',
  standalone: true,
  imports: [RouterLink, FormsModule, MatIconModule, MatFormFieldModule, MatProgressSpinnerModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <nav class="bc">Home <span class="bc-sep">›</span> <a routerLink="/app/m1">Master Data</a> <span class="bc-sep">›</span> <span>Currencies</span></nav>
    <section class="hero"><h1 class="brand-heading">Currencies</h1><p>ISO 4217 — code, symbol, decimal precision.</p></section>
    <section class="card">
      @if (loading()) { <div class="loading"><mat-spinner diameter="32"/></div> }
      @else {
        <table class="data">
...
/* ================================================================== */
@Component({
  selector: 'ulp-m1-uoms',
  standalone: true,
  imports: [RouterLink, FormsModule, MatIconModule, MatFormFieldModule, MatSelectModule, MatProgressSpinnerModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <nav class="bc">Home <span class="bc-sep">›</span> <a routerLink="/app/m1">Master Data</a> <span class="bc-sep">›</span> <span>Units of Measure</span></nav>
...
/* ================================================================== */
@Component({
  selector: 'ulp-m1-ports',
  standalone: true,
  imports: [RouterLink, FormsModule, MatIconModule, MatFormFieldModule, MatSelectModule, MatProgressSpinnerModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <nav class="bc">Home <span class="bc-sep">›</span> <a routerLink="/app/m1">Master Data</a> <span class="bc-sep">›</span> <span>Ports</span></nav>
    <section class="hero"><h1 class="brand-heading">Ports</h1><p>UN/LOCODE — sea, air, multimodal. CBP Schedule D codes for US ports.</p></section>
    <section class="filters">
      <mat-form-field appearance="outline" subscriptSizing="dynamic">
        <mat-label>Country</mat-label>
        <mat-select [(ngModel)]="country" (ngModelChange)="reload()">
...
/* ================================================================== */
@Component({
  selector: 'ulp-m1-holidays',
  standalone: true,
  imports: [RouterLink, FormsModule, MatIconModule, MatFormFieldModule, MatSelectModule, MatInputModule, MatProgressSpinnerModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <nav class="bc">Home <span class="bc-sep">›</span> <a routerLink="/app/m1">Master Data</a> <span class="bc-sep">›</span> <span>Holidays</span></nav>
    <section class="hero"><h1 class="brand-heading">Holiday Calendar</h1><p>Country / state holidays — used by SLA, due-date and working-day calculations.</p></section>
    <section class="filters">
      <mat-form-field appearance="outline" subscriptSizing="dynamic">
        <mat-label>Country</mat-label>
        <mat-select [(ngModel)]="country" (ngModelChange)="reload()">
    ...
    <section class="card">
      @if (loading()) { <div class="loading"><mat-spinner diameter="32"/></div> }
      @else if (rows().length === 0) { <p class="empty">No holidays for {{ country }} {{ year }}. Holiday data isn't seeded in Phase 1 — populated when M27 / scheduling needs it.</p> }
      @else {
        <table class="data">
