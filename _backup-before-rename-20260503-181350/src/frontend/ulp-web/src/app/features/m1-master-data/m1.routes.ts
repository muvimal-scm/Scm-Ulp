...
/**
 * M1 Master Data routes — all under /app/m1.
 * Lazy-loaded; each component is standalone.
 */
export const M1_ROUTES: Routes = [
  {
    path: '',
    loadComponent: () => import('./m1-home.component').then(m => m.M1HomeComponent),
  },
  // Parties
  {
    path: 'parties',
  ...
  // SCM Milestone 1 — Profile Detail (POAs, permits, misc docs)
  {
