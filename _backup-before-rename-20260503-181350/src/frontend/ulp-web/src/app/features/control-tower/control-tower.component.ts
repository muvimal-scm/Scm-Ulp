...
import { M5ApiService } from '../m5-freight/shared/m5-api.service';
import { ShipmentDto, TradeDirection, TransportMode } from '../m5-freight/shared/m5-types';
          ...
          <tbody>
            @for (s of rows(); track s.id) {
              <tr>
                ...
                <td><a [routerLink]="['/app/m5/shipments', s.id]" class="link">Open →</a></td>
              </tr>
            } @empty {
