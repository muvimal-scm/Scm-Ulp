...
import { M26ApiService } from '../shared/m26-api.service';
import { BriefUser } from '../shared/m26-types';

@Component({
  selector: 'ulp-m26-users',
  standalone: true,
  ...
  template: `
    ...
    <div class="toolbar">
      ...
      <button mat-flat-button color="primary" disabled matTooltip="Invite UI lands Phase 1.1">
          ...
          <tbody>
            @for (u of rows(); track u.id) {
              <tr>
                ...
                <td>{{ u.countryCode }}</td>
                <td>{{ u.lastLoginAt ? (u.lastLoginAt | slice:0:19) : '—' }}</td>
...
export class UsersListComponent implements OnInit {
  private readonly api = inject(M26ApiService);
