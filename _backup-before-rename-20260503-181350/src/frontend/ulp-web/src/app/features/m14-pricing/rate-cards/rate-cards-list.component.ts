...
import { RateCardDto, RateCardStatus, RateCardType } from '../shared/m14-types';

@Component({
  selector: 'ulp-m14-rate-cards',
  standalone: true,
  ...
  template: `
    ...
    <div class="toolbar">
      ...
      <button mat-flat-button color="primary" disabled matTooltip="Create UI lands Phase 2.1">
