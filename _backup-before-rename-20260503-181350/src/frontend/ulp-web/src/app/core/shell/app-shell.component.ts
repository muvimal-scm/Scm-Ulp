  ...
  protected readonly navGroups: NavGroup[] = [
      ...
      items: [
        {
          ...
          children: [
            { label: 'Rate cards',          icon: '', route: '/app/m14/rate-cards', status: 'live' },
            { label: 'Quotations',          icon: '', route: '/app/m14/quotes',     status: 'live' },
            { label: 'Surcharges',          icon: '', route: '/app/m14/surcharges', status: 'live' },
            { label: 'Customer contracts',  icon: '', route: '/app/m14/contracts',  status: 'live' },
          ],
        },
        {
          label: 'CRM & Sales', icon: 'groups',
          children: [
            { label: 'Leads',               icon: '', route: '/app/m2/leads',         status: 'live' },
            { label: 'Opportunities',       icon: '', route: '/app/m2/opportunities', status: 'live' },
            { label: 'Activities',          icon: '', route: '/app/m2/activities',    status: 'live' },
            { label: 'Campaigns',           icon: '', route: '/app/m2/campaigns',     status: 'live' },
            { label: 'RFQs',                icon: '', route: '/app/m2/rfqs',          status: 'live' },
            { label: 'Pipeline stages',     icon: '', route: '/app/m2/pipeline',      status: 'live' },
          ],
        },
        { label: 'Vendor management', icon: 'store', route: '/app/m3', status: 'live' },
        {
          label: 'Procurement', icon: 'shopping_cart',
          children: [
            { label: 'Purchase requests',  icon: '', route: '/app/m7/purchase-requests', status: 'live' },
            { label: 'Vendor RFQs',        icon: '', route: '/app/m7/rfqs',              status: 'live' },
            { label: 'Purchase orders',    icon: '', route: '/app/m7/purchase-orders',   status: 'live' },
            { label: 'Goods receipts',     icon: '', route: '/app/m7/grns',              status: 'live' },
            { label: 'Invoice matching',   icon: '', route: '/app/m7/invoice-matches',   status: 'live' },
          ],
        },
      ],
    },
      ...
      items: [
        {
          ...
          children: [
            { label: 'Bookings',                        icon: '', route: '/app/m5/bookings',  status: 'live' },
            { label: 'Shipments',                       icon: '', route: '/app/m5/shipments', status: 'live' },
            { label: 'Consolidations',                  icon: '', route: '/app/m5/consols',   status: 'live' },
            { label: 'Demurrage / detention',           icon: '', route: '/app/m5/demurrage', status: 'live' },
        ...
        },
        {
          ...
          children: [
            { label: 'Courier bookings',    icon: '', route: '/app/m9/bookings',    status: 'live' },
            { label: 'Routes',              icon: '', route: '/app/m9/routes',      status: 'live' },
            { label: 'Manifests',           icon: '', route: '/app/m9/manifests',   status: 'live' },
            { label: 'Proofs of delivery',  icon: '', route: '/app/m9/pods',        status: 'live' },
            { label: 'COD collections',     icon: '', route: '/app/m9/cod',         status: 'live' },
            { label: 'Zone rates',          icon: '', route: '/app/m9/zone-rates',  status: 'live' },
          ],
        },
        {
      ...
      items: [
        {
          ...
          children: [
            { label: 'Entries (7501)',              icon: '', route: '/app/m4/entries',        status: 'live' },
            { label: 'Holds & Exams',               icon: '', route: '/app/m4/holds',          status: 'live' },
            { label: 'ATM / POA',                   icon: '', route: '/app/m4/atm',            status: 'live' },
            { label: 'Release Orders',              icon: '', route: '/app/m4/release-orders', status: 'live' },
            { label: 'ISF (10+2)',                  icon: '', route: '/app/m4/isf',            status: 'live' },
            { label: 'In-Bond Moves',               icon: '', route: '/app/m4/in-bond',        status: 'live' },
            { label: 'Bonds',                       icon: '', route: '/app/m4/bonds',          status: 'live' },
            { label: 'ABI Messages',                icon: '', route: '/app/m4/abi-messages',   status: 'live' },
          ],
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Reminders',     icon: 'notifications_active', route: '/app/m5/reminders', status: 'live' },
        {
          ...
          children: [
            ...
            { label: 'DMS — document management',  icon: '', route: '/app/m21', status: 'live' },
        ...
        },
        {
          ...
          children: [
            { label: 'Templates',          icon: '', route: '/app/m6/templates',   status: 'live' },
            { label: 'Render test',        icon: '', route: '/app/m6/render-test', status: 'live' },
            { label: 'Render history',     icon: '', route: '/app/m6/history',     status: 'live' },
          ],
        },
        { label: 'Notifications inbox', icon: 'notifications', route: '/app/m27/inbox', status: 'live' },
      ],
    },
    {
      title: 'Finance',
      items: [
        {
          ...
          children: [
            { label: 'AR · Invoices',             icon: '', route: '/app/m17/invoices',  status: 'live' },
            { label: 'AP · Vendor bills',         icon: '', route: '/app/m17/bills',     status: 'live' },
            { label: 'Receipts (AR)',             icon: '', route: '/app/m17/receipts',  status: 'live' },
            { label: 'Payments (AP)',             icon: '', route: '/app/m17/payments',  status: 'live' },
            { label: 'A/R ↔ A/P Settlement',      icon: '', route: '/app/m17/settlement',status: 'live' },
            { label: 'Banking & Reconciliation',  icon: '', route: '/app/m17/banking',   status: 'live' },
            { label: 'Past-Due Notices',          icon: '', route: '/app/m17/past-due',  status: 'live' },
            { label: 'General Expense',           icon: '', route: '/app/m17/general-expense', status: 'live' },
            { label: 'Periods & close',           icon: '', route: '/app/m17/periods',   status: 'live' },
            { label: 'Chart of accounts',         icon: '', route: '/app/m17/accounts',  status: 'live' },
            { label: 'Reports (TB · P&L · BS · Aging)', icon: '', route: '/app/m17/reports', status: 'live' },
            { label: 'Comparative Profit by Year',icon: '', route: '/app/m17/comparative-profit', status: 'live' },
            { label: 'Email Templates',           icon: '', route: '/app/m17/email-templates',   status: 'live' },
          ],
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          children: [
            { label: 'Master data',                  icon: '', route: '/app/m1', status: 'live' },
            { label: 'User management & roles',      icon: '', route: '/app/m26', status: 'live' },
            { label: 'Notification preferences',     icon: '', route: '/app/m27/preferences', status: 'live' },
            { label: 'Auto-notification rules',      icon: '', route: '/app/m27/rules',       status: 'live' },
