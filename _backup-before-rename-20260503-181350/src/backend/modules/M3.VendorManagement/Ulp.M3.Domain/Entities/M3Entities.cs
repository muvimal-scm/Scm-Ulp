...
namespace Ulp.M3.Domain.Entities;

// LLD §3.1 — vendor satellite over m1_party
...
// LLD §3.3 — entity renamed from VendorService to avoid C# name collision with
// the application-service class (Ulp.M3.Infrastructure.Persistence.VendorService).
