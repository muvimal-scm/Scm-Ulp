...
namespace Ulp.M27.Infrastructure.Persistence;

public sealed class M27DbContext(DbContextOptions<M27DbContext> options) : DbContext(options)
{
    ...
    // SCM Milestone 3 enum mappers — SCREAMING_SNAKE in DB.
    ...
    // ENUM('EMAIL','SMS','WHATSAPP','IN_APP','WEBHOOK') — explicit string mapping because the C# enum
