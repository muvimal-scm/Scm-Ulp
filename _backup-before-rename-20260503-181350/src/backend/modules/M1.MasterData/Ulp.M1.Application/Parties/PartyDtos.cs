...
/// <summary>
/// Read DTO for a party — what API responses serialise.
...
/// <summary>Update-party request body — same shape minus identifiers (those have their own endpoints).</summary>
