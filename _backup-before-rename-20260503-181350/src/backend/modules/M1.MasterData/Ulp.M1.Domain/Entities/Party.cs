...
/// <summary>
/// Universal party — customer / vendor / carrier / broker / bank / agency / employee.
/// Per ULP_LLD_M1_v2.0_MasterData.docx §3 (universal party model).
/// Country-specific identifiers (PAN, GSTIN, EIN, ABA…) live in <see cref="PartyIdentifier"/>.
/// </summary>
public sealed class Party : IEntity, ITenantScoped
{
    ...
    // Persisted as two flat columns (credit_limit, credit_currency) — EF Core 8
    ...
    public string? TaxStatus { get; set; }            // "Regular GST" (IN) | "Tax Exempt" (US) | …
...
/// <summary>Per LLD §3 — enumeration of party types.</summary>
