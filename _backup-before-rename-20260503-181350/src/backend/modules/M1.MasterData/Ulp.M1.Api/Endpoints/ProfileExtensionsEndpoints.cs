...
namespace Ulp.M1.Api.Endpoints;
...
public static class ProfileExtensionsEndpoints
{
    ...
    {
        var g = app.MapGroup("/api/v1/m1/parties/{partyId:long}").WithTags("M1 · Profile Extensions").RequireAuthorization();
        ...
        g.MapPost("/poas", async (
            ...
            Results.Created($"/api/v1/m1/parties/{partyId}/poas", await repo.AddPoaAsync(partyId, req, ct)));
        ...
        g.MapPost("/permits", async (
            ...
            [FromServices] IProfileExtensionsRepository repo,
            CancellationToken ct) =>
            Results.Created($"/api/v1/m1/parties/{partyId}/permits", await repo.AddPermitAsync(partyId, req, ct)));
        ...
        g.MapPost("/misc-docs", async (
            ...
            [FromServices] IProfileExtensionsRepository repo,
            CancellationToken ct) =>
            Results.Created($"/api/v1/m1/parties/{partyId}/misc-docs", await repo.AddMiscDocAsync(partyId, req, ct)));
