...
/// <summary>
/// M26 DbContext — strictly per docs/lld/M26_RBAC_v1.0.md table shapes.
...
/// </summary>
public sealed class M26DbContext(DbContextOptions<M26DbContext> options) : DbContext(options)
{
