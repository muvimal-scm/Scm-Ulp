...
public static class BookingEndpoints
{
    ...
    {
        var g = app.MapGroup("/api/v1/m5/bookings").WithTags("M5 · Bookings").RequireAuthorization();
        ...
        g.MapPost("/", async (
            ...
            [FromServices] IFreightService svc, CancellationToken ct) =>
        {
            try   { return Results.Created("/api/v1/m5/bookings/", await svc.CreateBookingAsync(req, ct)); }
        ...
        g.MapPost("/{id:long}/lines", async (long id,
            ...
            [FromServices] IFreightService svc, CancellationToken ct) =>
        {
            try   { return Results.Created($"/api/v1/m5/bookings/{id}/lines", await svc.AddBookingLineAsync(id, req, ct)); }
