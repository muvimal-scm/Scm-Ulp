...
namespace Ulp.M7.Infrastructure.Persistence;

public sealed class M7DbContext(DbContextOptions<M7DbContext> options) : DbContext(options)
{
    ...
    // ENUM('ThreeWayMatched','PriceVariance','QtyVariance','NoPO','Disputed') — NoPO has odd casing
