...
namespace Ulp.M4.Application;

// =====================================================================
// M4 Customs application contract — currently the M4-US plugin surface
// per sealed LLD §11. The country-agnostic M4-Core endpoints will be
