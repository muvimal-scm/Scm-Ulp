...
/// </summary>
public sealed class M17DbContext(DbContextOptions<M17DbContext> options) : DbContext(options)
{
    // Core
    ...
    // Keyless projection over m1_party (read-only) — used by AccountsService for legal_name lookups
    // without taking a project dependency on the M1 module.
    public DbSet<PartyLookup> PartyLookups => Set<PartyLookup>();

    // M17 finish — Milestone 3 closure tables
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        // ===== M17 finish — extension table mappings =====
